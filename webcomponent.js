(function () {
    ...
    tmpl.innerHTML = `<link rel="stylesheet" type="text/css" href="https://port3134-workspaces-ws-sbsln.eu20.applicationstudio.cloud.sap//DatePicker/light.css"/>`;
    ...
    class DatePicker extends HTMLElement {
        ...
        async checkForUpdates() {
            try {
                const contribution = await (await fetch("https://github.com/SAC-Custom-Widgets/datepicker/blob/master/releases/latest/datepicker.json")).json();
        ...
        set darktheme(value) {
            this.querySelector("link").setAttribute("href", "https://port3134-workspaces-ws-sbsln.eu20.applicationstudio.cloud.sap//DatePicker/" +
